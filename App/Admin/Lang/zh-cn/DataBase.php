...
return array(
	...
	'DUMP_TIPS'=>'<span style="color:#f00;">备份成功后，最好将备份文件通过FTP下载到本地保存，以免发生信息泄露(备份文件保存在网站 /Data/db_backup 目录下)；</span><br/><span style="color:#f00;">如果要恢复数据库可将备份文件上传到网站 /Data/db_backup 目录下，然后进行恢复操作； </span>',
