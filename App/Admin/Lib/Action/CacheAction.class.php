...
class CacheAction extends CommonAction
{
	...
	{
		$root_dir = ROOT_PATH.'/Data/caches/custom/';
	...
	public function systemClear()
	{
		...
		{
			usleep(50);
			clearDir(ROOT_PATH.'/Data/tpl/caches/static');
			usleep(50);
			clearDir(ROOT_PATH.'/Data/tpl/caches/dynamic');
			usleep(50);
    		clearDir(ROOT_PATH.'/Data/tpl/compiled');
    		usleep(50);
    		clearDir(ROOT_PATH.'/Data/tpl/caches/adv_position');  			
			echoFlush('<script type="text/javascript">showmessage(\''.L('SYSTEM_TIPS8').'\',1);</script>');
		}
		@file_put_contents(ROOT_PATH.'/Data/is_clear.lock',TIMESTAMP);
		usleep(100);
	...
	{
		$custom_dir = ROOT_PATH.'/Data/caches/custom/';
